...
function InstSearch({navigation}) {
    return (
...
<View><Text style={{paddingTop:20,fontSize:17, fontWeight:'bolder'}}>Previously Viewed Locums</Text>

<Previous/>

</View>

<View><Text style={{paddingTop:20, fontSize:17, fontWeight:'bolder'}}>Most Matched Locums / Offers</Text>
...
const MyComponent = () => {
  ...
  return (
    ...
    style= {{backgroundColor:'#F3F3F3', borderRadius:15,marginTop:10, }}
      placeholder='Search a locum here..'
