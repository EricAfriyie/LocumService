...
export default function InstitutionRegisterScreen({ navigation }) {
...
<TextInput
      ...
      <Button
        mode="contained"
        onPress={()=>navigation.navigate('InstitutionProfileSetUp1')}
        style={{ marginTop: 10 }}
      >
        Sign Up
      </Button>
      <View style={styles.row}>
        ...
        <TouchableOpacity onPress={()=>navigation.navigate('InstitutionLogin')}>
